...
export const metadata: Metadata = {
  ...
  description: "IT компания в СНГ и Казахстане с 2016 года. ✓10+ лет опыта ✓50+ реализованных проектов ✓Собственные инновационные VR/AR/MR технологии ✓Международные награды ✓Разработка мобильных приложений и сайтов премиум-класса ✓Гарантия результата",
  keywords: [
  ...
  openGraph: {
    title: "AVR Group - Лидер IT-индустрии в СНГ и Казахстане с 2016 года",
    description: "10+ лет создаем передовые VR/AR/MR решения, мобильные приложения и веб-платформы. 50+ успешных проектов, международное признание, инновационные технологии.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'AVR Group - Ведущая IT-компания в СНГ и Казахстане с 2016 года',
      }
    ],
  },
  twitter: {
