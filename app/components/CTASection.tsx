...
export default function CTASection({
  ...
  return (
    <section className={`py-20 px-4 bg-zinc-900/50 backdrop-blur-sm relative ${className}`}>
      <div className="container mx-auto relative">
        ...
        >
          {/* Ургентность для увеличения конверсии */}
          {urgencyText && (
            <motion.div
              ...
              className="mb-6"
            >
              <span className="inline-block px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-full animate-pulse">
                ⚡ {urgencyText}
              </span>
            </motion.div>
          )}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <motion.a
              ...
              className="inline-flex items-center px-8 py-4 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-all duration-300 text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1"
