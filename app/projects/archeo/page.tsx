...
export default function ArcheoPage() {
  const features = [
    {
      title: 'Календарь событий',
      description: 'Интерактивный календарь научных мероприятий и событий'
    },
    {
      title: 'Научные публикации',
      description: 'Управление монографиями, сборниками и публикациями'
    },
    {
      title: 'Лекторий',
      description: 'Организация и управление научными лекциями'
    },
    {
      title: 'Структура института',
      description: 'Представление организационной структуры и сотрудников'
    },
    {
      title: 'Публикационная активность',
      description: 'Учет и анализ научных публикаций сотрудников'
    },
    {
      title: 'Административная панель',
      description: 'Полноценная система управления контентом'
    }
  ];

  const specs = [
    { name: 'Тип системы', value: 'Корпоративный портал' },
